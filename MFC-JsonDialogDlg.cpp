...
// MFC-JsonDialogDlg.cpp : implementation file
//
...
void CMFCJsonDialogDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
void CMFCJsonDialogDlg::OnPaint()
{
	if (IsIconic())
	{
...
HCURSOR CMFCJsonDialogDlg::OnQueryDragIcon()
{
